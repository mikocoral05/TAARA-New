<template>
  <q-page>
    ...
    >
      <div
        class="flex row no-wrap absolute-center justify-center items-center q-px-md"
      >
        <div
          class="flex column justify-center items-center left-container q-pa-xl"
        >
          <div class="flex row no-wrap" style="width: 100%">
            ...
            <div class="flex column">
              ...
              <p style="white-space: preline">
                Please log in first to access our features
              </p>
            </div>
          </div>
          <q-input
            class="qinput bg-white"
            filled
        ...
        <div
          class="flex column justify-center items-center bg-white q-mr-sm q-pa-sm register-box"
        >
          <h6 class="q-ma-sm" style="white-space: nowrap">
            Don’t have an account yet?
          </h6>
          <div class="flex no-wrap justify-center items-center q-ma-none">
            <p style="font-size: 15px; width: 100px; white-space: pre-line">
              Our pets would like to know you more...but you need to sign up
              first.
            </p>
...
export default defineComponent({
  ...
  setup() {
    ...
    let password = ref("");
    watch(wrongUserOrPass, (newValue, oldValue) => {
      if (newValue == true) {
