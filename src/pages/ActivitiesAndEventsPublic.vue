<template>
  <q-page>
    <div class="flex justify-center items-center q-pa-sm">
      <div
        v-for="(data, index) in activitiesAndEventsData"
        :key="index"
      ...
      >
        ...
        <div class="q-ma-sm flex row no-wrap image-container q-mt-lg" v-if="data?.image_path">
          <q-img class="radius-10" :src="data.image_path" :ratio="16 / 9" />
        </div>
...
export default {
  ...
  setup() {
    ...
    const activitiesAndEventsData = ref([])
