<template>
  <q-page>
    ...
    >
      ...
      >
        <div
          class="flex row justify-between items-center big-announcement-title-container"
        >
          <div class="flex row justify-center items-center q-px-md">
            <div
              class="flex column justify-start items-start q-ma-sm announcement-title-container"
            >
              <h4 class="q-ma-none q-pa-none announcement-title">
                Announcements
              </h4>
            </div>
          </div>
          <div
            class="flex column justify-center items-center q-pr-md date-and-time-container"
          >
...
<style
  lang="scss"
  scoped
  src="../pages/taara/style/announcementsPage.scss"
></style>
