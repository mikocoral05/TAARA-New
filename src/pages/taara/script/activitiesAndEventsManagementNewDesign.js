...
import { resizeImage, wordifyDate, wordifyTime, dateToday } from 'src/composable/simpleComposable'
...
export default {
  setup() {
    ...
    let navigateEvents = (eventId) => {
      ...
      localStorage.setItem('activitiesAndEventsDataSpecificId', JSON.stringify(eventId))
    }
    ...
    return {
      ...
      listOfEvents,
      getEventColor(date) {
        const colors = ['secondary', 'accent', 'warning', 'purple', 'positive', 'negative']
