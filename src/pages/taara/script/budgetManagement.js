import lineCharts from 'src/components/lineCharts.vue'
  ...
  setup() {
    ...
    let getDays = () => {
      ...
      if (filteredDate.value.month.value == monthNames[monthToday].value) {
        ...
        let date = filteredDate.value.year + '-' + formatted_month + '-' + day.value
    ...
    let selectDay = (obj) => {
      let formatted_month = ('0' + filteredDate.value.month.value).slice(-2)
      let fullDate = filteredDate.value.year + '-' + formatted_month + '-' + obj
    ...
    let submitExpense = (addInfo) => {
      let formatted_month = ('0' + filteredDate.value.month.value).slice(-2)
      let fullDate = filteredDate.value.year + '-' + formatted_month + '-' + day.value
