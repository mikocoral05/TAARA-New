  ...
  setup() {
    ...
    let viewDetails = (index, report_id) => {
      if (pending.value == "Pet adoption") {
        ...
        nameDisplay.value =
          adoptionDetails.value.first_name +
          " " +
          adoptionDetails.value.last_name;
        ...
        nameDisplay.value =
          volunteerDetails.value.first_name +
          " " +
          volunteerDetails.value.last_name;
        selectedDays.value =
          volunteerDetails.value.most_available_day.split(",");
