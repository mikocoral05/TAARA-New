...
export default {
  ...
  setup() {
    ...
    let toggleAnimalType = (type) => {
      if (type === 'dog') {
        search.value.animal_type = search.value.animal_type === 'dog' ? '' : 'dog'
      } else if (type === 'cat') {
        search.value.animal_type = search.value.animal_type === 'cat' ? '' : 'cat'
      }
    }
    let toggleAnimalSize = (size) => {
      if (size === 'small') {
        ...
        search.value.size = search.value.size === 'extra large' ? '' : 'extra large'
      }
    }
    ...
    let toggleAnimalGoodWith = (good_width) => {
      if (good_width === 'kids') {
        search.value.good_with = search.value.good_with === 'kids' ? '' : 'kids'
      } else if (good_width === 'dogs') {
        search.value.good_with = search.value.good_with === 'dogs' ? '' : 'dogs'
      } else if (good_width === 'cats') {
        search.value.good_with = search.value.good_with === 'cats' ? '' : 'cats'
      }
    }
    // let age = ref();
    function getAge(age) {
