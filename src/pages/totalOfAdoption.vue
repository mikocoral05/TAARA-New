    ...
    <div class="flex justify-center items-center text-white">
      <div class="first-container q-ma-lg q-mx-xl q-pb-sm">
        <div class="flex row justify-between items-center q-pb-md">
          ...
          <div class="row justify-center items-center q-ml-xl total-adoption-container">
            <div
...
import { weekCount, yearToday, monthToday, monthNames } from 'src/composable/simpleComposable'
